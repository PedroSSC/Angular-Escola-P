...
export class TurmasService {
  ...
  @Output()
  onGetSelected = new EventEmitter<Turma>();
  ...
  selectTurma(sTurma: Turma):Turma{
    this.selected = this.getTurma(sTurma.codigo);
    this.onGetSelected.emit(sTurma);
